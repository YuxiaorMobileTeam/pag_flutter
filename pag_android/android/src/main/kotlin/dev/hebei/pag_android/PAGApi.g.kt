...
private object PAGApiPigeonUtils {

  fun createConnectionError(channelName: String): PAGError {
...
private class PAGApiPigeonInstanceManagerApi(val binaryMessenger: BinaryMessenger) {
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, instanceManager: PAGApiPigeonInstanceManager?) {
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PigeonInternalInstanceManager.removeStrongReference", codec)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PigeonInternalInstanceManager.clear", codec)
        if (instanceManager != null) {
...
{
    val channelName = "dev.flutter.pigeon.pag_android.PigeonInternalInstanceManager.removeStrongReference"
    ...
    channel.send(listOf(identifierArg)) {
      if (it is List<*>) {
        ...
        callback(Result.failure(PAGApiPigeonUtils.createConnectionError(channelName)))
      } 
    }
  }
}
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?) {
    ...
    if (value is org.libpag.PAGView) {
      registrar.getPigeonApiPAGViewApi().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("PAGViewApi", value, it.exceptionOrNull())
        }
      }
    }
      ...
      registrar.getPigeonApiPAGFileApi().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("PAGFileApi", value, it.exceptionOrNull())
        }
      }
    }
      ...
      registrar.getPigeonApiPAGCompositionApi().pigeon_newInstance(value) {
        if (it.isFailure) {
          logNewInstanceFailure("PAGCompositionApi", value, it.exceptionOrNull())
        }
      }
    }
...
abstract class PigeonApiPAGViewApi(open val pigeonRegistrar: PAGApiPigeonProxyApiRegistrar) {
  ...
  abstract fun setCompositon(pigeon_instance: org.libpag.PAGView, value: org.libpag.PAGComposition)

  abstract fun getRepeatCount(pigeon_instance: org.libpag.PAGView): Long

  abstract fun setRepeatCount(pigeon_instance: org.libpag.PAGView, value: Long)

  abstract fun getScaleMode(pigeon_instance: org.libpag.PAGView): PAGScaleModeApi
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiPAGViewApi?) {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.pigeon_defaultConstructor", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.getComposition", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.setCompositon", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
            val valueArg = args[1] as org.libpag.PAGComposition
            val wrapped: List<Any?> = try {
              api.setCompositon(pigeon_instanceArg, valueArg)
              listOf(null)
            } catch (exception: Throwable) {
              PAGApiPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.getRepeatCount", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
            val wrapped: List<Any?> = try {
              listOf(api.getRepeatCount(pigeon_instanceArg))
            } catch (exception: Throwable) {
              PAGApiPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.setRepeatCount", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
            ...
            val wrapped: List<Any?> = try {
              api.setRepeatCount(pigeon_instanceArg, valueArg)
              listOf(null)
            } catch (exception: Throwable) {
              PAGApiPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.getScaleMode", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
            val wrapped: List<Any?> = try {
              listOf(api.getScaleMode(pigeon_instanceArg))
            } catch (exception: Throwable) {
              PAGApiPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.setScaleMode", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.getProgress", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.setProgress", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.isPlaying", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.play", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.pause", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGViewApi.stop", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGView
  ...
  fun pigeon_newInstance(pigeon_instanceArg: org.libpag.PAGView, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      val channelName = "dev.flutter.pigeon.pag_android.PAGViewApi.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
...
abstract class PigeonApiPAGCompositionApi(open val pigeonRegistrar: PAGApiPigeonProxyApiRegistrar) {
  abstract fun getWidth(pigeon_instance: org.libpag.PAGComposition): Long

  abstract fun getHeight(pigeon_instance: org.libpag.PAGComposition): Long
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiPAGCompositionApi?) {
      val codec = api?.pigeonRegistrar?.codec ?: PAGApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGCompositionApi.getWidth", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGCompositionApi.getHeight", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_instanceArg = args[0] as org.libpag.PAGComposition
  ...
  fun pigeon_newInstance(pigeon_instanceArg: org.libpag.PAGComposition, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.pag_android.PAGCompositionApi.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
...
abstract class PigeonApiPAGFileApi(open val pigeonRegistrar: PAGApiPigeonProxyApiRegistrar) {
  abstract fun asset(asset: String): org.libpag.PAGFile
  ...
  companion object {
    ...
    fun setUpMessageHandlers(binaryMessenger: BinaryMessenger, api: PigeonApiPAGFileApi?) {
      val codec = api?.pigeonRegistrar?.codec ?: PAGApiPigeonCodec()
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGFileApi.asset", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
            val assetArg = args[1] as String
            val wrapped: List<Any?> = try {
              api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.asset(assetArg), pigeon_identifierArg)
              listOf(null)
            } catch (exception: Throwable) {
              PAGApiPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.pag_android.PAGFileApi.file", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val pigeon_identifierArg = args[0] as Long
            ...
            val wrapped: List<Any?> = try {
              api.pigeonRegistrar.instanceManager.addDartCreatedInstance(api.file(fileArg), pigeon_identifierArg)
              listOf(null)
            } catch (exception: Throwable) {
              PAGApiPigeonUtils.wrapError(exception)
            }
  ...
  fun pigeon_newInstance(pigeon_instanceArg: org.libpag.PAGFile, callback: (Result<Unit>) -> Unit)
{
    if (pigeonRegistrar.ignoreCallsToDart) {
      ...
      val binaryMessenger = pigeonRegistrar.binaryMessenger
      val codec = pigeonRegistrar.codec
      val channelName = "dev.flutter.pigeon.pag_android.PAGFileApi.pigeon_newInstance"
      val channel = BasicMessageChannel<Any?>(binaryMessenger, channelName, codec)
      channel.send(listOf(pigeon_identifierArg)) {
        if (it is List<*>) {
          if (it.size > 1) {
