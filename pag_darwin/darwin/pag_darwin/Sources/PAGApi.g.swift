...
internal final class PAGApiPigeonInternalFinalizer {
  ...
  internal weak var delegate: PAGApiPigeonInternalFinalizerDelegate?
  ...
  static func detach(from instance: AnyObject) {
    let finalizer = objc_getAssociatedObject(instance, associatedObjectKey) as? PAGApiPigeonInternalFinalizer
  ...
  func removeAllObjects() throws {
    lockQueue.sync {
      ...
      while let instance = weakInstancesEnumerator.nextObject() {
        PAGApiPigeonInternalFinalizer.detach(from: instance as AnyObject)
      }
